...
function EmotionsPage() {
  ...
  function setSadPrompt() {
    let sadPrompts = [
      "I feel sad because I lost someone close to me and I want to watch a movie that helps me with grieving",
  ...
  function setHappyPrompt() {
    let happyPrompts = [
      "I am feeling happy today and I want to watch a movie that compasses this feeling",
  ...
  function setAngryPrompt() {
    let angryPrompts = [
      "I am annoyed at my family and I want to watch a movie that helps me to learn how to deal with this feeling",
  ...
  function setFearPrompt() {
    let fearPrompts = [
      "I am concerned about the faith of the world and I want to watch something to make me more hopeful about the future",
  ...
  function setHopefulPrompt() {
    let hopefulPrompts = [
      "I feel very hopeful and therefore I want to watch a movie to make me even more hopeful",
  ...
  function setCuriousPrompt() {
    let curiousPrompts = [
      "I am feeling curious to learn about world war two, even if that makes me cry",
